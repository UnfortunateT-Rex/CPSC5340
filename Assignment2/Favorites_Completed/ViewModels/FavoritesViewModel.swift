...
class FavoritesViewModel : ObservableObject {
    ...
    let cityManager = CategoryManager<CityModel>(storageKey: "favoriteCities")
    let hobbyManager = CategoryManager<HobbyModel>(storageKey: "favoriteHobbies")
    let bookManager = CategoryManager<BookModel>(storageKey: "favoriteBooks")
